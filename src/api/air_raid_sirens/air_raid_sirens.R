...
# saveRDS(data_air_raid_siren_raw, "data/air_raid_sirens/data_air_raid_siren_raw.RDS")

data_air_raid_siren_raw <- readRDS("../../../data/air_raid_sirens/data_air_raid_siren_raw.RDS")

data_air_raid_siren <- data_air_raid_siren_raw %>%
  select(text) %>%
...
which(is.na(data_air_raid_siren$status))
